	...
	return (
		<div>
			...
			<div className='p-3 lg:p-0'>
				...
				<div className='flex items-center lg:gap-10 gap-4 mx-auto justify-center mb-10'>
					<IdeologyItem
						title='신뢰'
						title2='Trust'
...
const IdeologyItem = ({
	...
	return (
		...
		>
			<div className='relative w-26 h-26 lg:w-44 lg:h-44'>
				<Image
					src={imageSrc}
					alt='이념사진'
					width={1280}
				...
				<div className='absolute inset-0 flex flex-col items-center justify-center bg-black/50 rounded-full'>
					<div className='lg:text-2xl text-base font-bold mb-1'>{title}</div>
					<div className='lg:text-xl text-xs'>{title2}</div>
				</div>
			</div>
		</motion.div>
	)
